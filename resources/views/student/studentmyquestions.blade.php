            ...
            <div class="social_post">
              ...
              <div class="post_content">
                ...
                <div class="post_status">
                  <span class="quequed"><i class="mdi mdi-check"></i> Quequed</span>
                  <span class="viewed"><i class=" mdi mdi-clock-outline"></i> 129 Views</span>
                  <span class="paid">Dispute</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="common-box">
            <div class="social_post">
              ...
              <div class="post_content">
                ...
                <div class="post_status">
                  <span class="quequed">
                    <i class="mdi mdi-check"></i> Quequed
                  </span>
                  <span class="viewed"><i class=" mdi mdi-clock-outline"></i> 129 Views</span>
                  <span class="paid">Paid . Dispute </span>
                </div>
              </div>
            </div>
          </div>
