<header>
  <nav class="navbar navbar-default nav-red-transperant custom-nav" id="myHeader">
    ...
    <!-- Brand and toggle get grouped for better mobile display -->
      ...
      <!--   <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <a class="navbar-brand" href="{{url('/')}}"><img src="{{asset('/')}}/images/logo-white.png"></a>
      </div>
      <div class="  navbar-collapse" id="bs-example-navbar-collapse-1">
         
        <form method="get" action="{{url('/student/search')}}" class="navbar-form navbar-left hidden-xs">
        ...
        <ul class="nav navbar-nav navbar-right">          
            ...
            <div class="dropdown-menu">
              ...
              <ul>
               @if($message)
                ...
                @if(isset($mess['type']))
                <li>
                  <a href="@if(!isset($mess['dispute_id'])){{url('/student/questiondetail/'.($mess['qid']))}} @else {{url('/student/disputedisplay/'.($mess['dispute_id']))}} @endif">
          ...
          <li class="dropdown user-drop"><a href="#" class="userdrop dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="drop-pic">
            ...
            @else
             <img src="{{asset('/').'/images/student-profile-avatar.png' }}"> </span></a>
             @endif
